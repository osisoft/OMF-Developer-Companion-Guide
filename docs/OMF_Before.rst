...
Understand your data
  You must understand how the data you intend to send to the PI System will be organized in the PI System back-end. 
...
Write OMF messages to create your reference model and start feeding data into PI System 
  ...
  with the DCM/Relay to get appropriate authorization to feed data into PI System, and write and send OMF messages to 
...
Identify the reference model for your PI System 
...
In OMF applications, type definitions and their representations in the PI System, are immutable; that is, you cannot 
